...
["sep", Separator, { }],
    ...
    ["practice", aj, {s: "Every boy[i] likes his[i] mother.",
                      instructions: "Whenever you see '[i]' in a sentence, you must interpret the sentence in such a way that everything indexed with '[i]' covaries with each other. In this case, you must interpret this sentence as 'for every x, x a boy, x likes x's mother.', and then give your acceptability judgement."}],
